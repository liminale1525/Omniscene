...
assert.match(source, /readerCore:\s*\{[\s\S]*import\('\.\/qianmu-reader\.js\?v=1\.59\.60'\)[\s\S]*reader = module/, 'the companion parser must load through the shared feature runtime');
