...
assert.match(indexSource, /storyboardContract:[\s\S]*import\('\.\/qianmu-storyboard-contract\.js\?v=1\.59\.31'\)/, 'the contract validator must stay outside the startup graph');
